...
const ChainShow = (props) => {
  return (
    ...
    <View style={styles.accountCard}>
            ...
            <Chain img={require('../assets/tether.png')} name="Polygon" value="200000"/>
            <Chain img={require('../assets/bitcoin.png')} name="Gnosis" value="200000"/>
            <Chain img={require('../assets/bitcoin.png')} name="Fuse" value="200000"/>
            <Chain img={require('../assets/bitcoin.png')} name="Bianace" value="200000"/>
